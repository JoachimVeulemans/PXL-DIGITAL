...
DROP TABLE inschrijvingen_kindgegevens CASCADE CONSTRAINTS;
DROP TABLE inschrijvingen CASCADE CONSTRAINTS;
DROP TABLE vakanties CASCADE CONSTRAINTS;
DROP TABLE verblijfplaatsen CASCADE CONSTRAINTS;

DROP TABLE klanten CASCADE CONSTRAINTS;

DROP TABLE gemeenten CASCADE CONSTRAINTS;

DROP TABLE landen CASCADE CONSTRAINTS;
