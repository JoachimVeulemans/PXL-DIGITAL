...
public class Bankrekening {
	...
	public Bankrekening(String rekeningnummer, String naam, double saldo, double rentpercentage) throws NegatiefGetalException {
	...
	public void setRentpercentage(double rentpercentage) throws NegatiefGetalException {
		this.rentpercentage = rentpercentage;
		controle();
	}

	public Bankrekening() throws NegatiefGetalException {
		this("geen", "onbekend", 0, 1.2);
	}

	public void controle() throws NegatiefGetalException {
		if (this.saldo < 0) {
			this.saldo = 0;
			throw new NegatiefGetalException("Saldo is negatief");
		}
		if (this.rentpercentage < 0) {
			this.rentpercentage = 0;
			throw new NegatiefGetalException("Rentpercentage is negatief");
		}
	}
	...
	public void setSaldo(double saldo) throws NegatiefGetalException {
		this.saldo = saldo;
		controle();
	}
	...
	public void verrichting(double... waardesOpnemen) throws NegatiefGetalException {
		if (this.controleRekening()) {
