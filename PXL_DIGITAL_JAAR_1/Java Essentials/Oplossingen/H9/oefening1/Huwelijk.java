...
public class Huwelijk {
	...
	private Datum huwDatum = new Datum();

	{
		...
		System.out.println(persoon1.getVoornaam() + " " + persoon1.getNaam() + " en " + persoon2.getVoornaam() + " "
				+ persoon2.getNaam() + " zijn gehuwd op " + huwDatum.getDag() + " " + huwDatum.getMaandNaam() + " "
				+ huwDatum.getJaar() + ". Proficiat!");
	}
	...
	public Huwelijk(Persoon man, Persoon vrouw, int dag, int maand, int jaar) {
		...
		persoon2 = vrouw;
		huwDatum.setDag(dag);
		huwDatum.setMaand(maand);
		huwDatum.setJaar(jaar);
	}
