...
public class TeVerkopenBouwGrond extends BouwGrond {
	...
	public TeVerkopenBouwGrond(String perceelNr, float perceelGrootte, String bouwVoorschrift) {
	...
	public void doeEenBod(double bod, LocalDate datum) {
		if (this.notaris != null && ChronoUnit.DAYS.between(this.datumTeKoop, datum) >= 10) {
